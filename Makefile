...
LOCAL_TESTER_RESULTS ?= $(UNO_DIR)/test-results
...
LOCAL_TESTER_IMAGE ?= mentalsmash/uno-test-runner:latest
...
BASE_UNIT_TEST_COMMAND := \
  pytest -s -v \
    --junit-xml=$(LOCAL_TESTER_RESULTS)/$(TEST_JUNIT_REPORT)__unit.xml \
    test/unit
...
test-integration: .venv
	...
	mkdir -p $(LOCAL_TESTER_RESULTS)
	$</bin/pytest -s -v \
		--junit-xml=$(LOCAL_TESTER_RESULTS)/$(TEST_JUNIT_REPORT)__integration.xml \
		test/integration \
