...
from ..registry.vpn_settings import ParticlesVpnSettings
...
from ..registry.keys_dds import DdsKeysBackend
...
class CellAgent(Agent):
  ...
  def lans(self) -> set[LanDescriptor]:
    ...
    return {
      ...
      for nic in NicDescriptor.list_local_networks(skip=[
  ...
  def deserialize(serialized: dict,
    ...
    return CellAgent(
      root=root,
      uvn_id=Uvn.deserialize(serialized["uvn_id"]),
