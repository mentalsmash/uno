...
def _parser_args_registry(parser: argparse._SubParsersAction,
  ...
  parser.add_argument("-p", "--password",
    metavar="PASSWORD",
    help="A password for the UVN's owner.",
    default=None)
...
def uno_parser(parser: argparse.ArgumentParser):
  ...
  # uno define ...
  #############################################################################
  grp_define = cli_command_group(subparsers, "define",
    title="UVN Definition",
    help="Create a new UVN, add cells, add particles.")

  #############################################################################
  # uno define uvn ...
  #############################################################################
  cmd_define_uvn = cli_command(grp_define, "uvn",
    cmd=registry_define_uvn,
  ...
  # uno define cell ...
  #############################################################################
  cmd_define_cell = cli_command(grp_define, "cell",
    cmd=registry_define_cell,
  ...
  # uno define particle ...
  #############################################################################
  cmd_define_particle = cli_command(grp_define, "particle",
    cmd=registry_define_particle,
  ...
  # uno define user ...
  #############################################################################
  cmd_define_user = cli_command(grp_define, "user",
    cmd=registry_define_user,
    help="Add a new user to the UVN.")

  cmd_define_user.add_argument("email",
    help="A unique email for the user.")
  ...
  # uno config ...
  #############################################################################
  grp_config = cli_command_group(subparsers, "config",
  ...
  # uno config uvn ...
  #############################################################################
  cmd_config_uvn = cli_command(grp_config, "uvn",
  ...
  # uno config cell ...
  #############################################################################
  cmd_config_cell = cli_command(grp_config, "cell",
    cmd=registry_config_cell,
  ...
  # uno config particle ...
  #############################################################################
  cmd_config_particle = cli_command(grp_config, "particle",
    cmd=registry_config_particle,
    help="Update a particle's configuration.")
  ...
  # uno config user ...
  #############################################################################
  cmd_config_user = cli_command(grp_config, "user",
    cmd=registry_config_user,
    help="Update a user's configuration.")
  ...
  # uno redeploy ...
  #############################################################################
  cmd_redeploy = cli_command(subparsers, "redeploy",
  ...
  # uno sync ...
  #############################################################################
  cmd_sync = cli_command(subparsers, "sync",
    cmd=agent_sync,
  ...
  # uno install ...
  #############################################################################
  cmd_install = cli_command(subparsers, "install",
    cmd=agent_install,
  ...
  # uno update ...
  #############################################################################
  cmd_update = cli_command(subparsers, "update",
    cmd=agent_update,
  ...
  # uno service ...
  #############################################################################
  grp_service = cli_command_group(subparsers, "service",
  ...
  # uno service install ...
  #############################################################################
  cmd_service_enable = cli_command(grp_service, "install",
  ...
  # uno agent ..
  #############################################################################
  cmd_agent = cli_command(subparsers, "agent",
    cmd=agent_run,
  ...
  # uno ban ...
  #############################################################################
  grp_ban = cli_command_group(subparsers, "ban",
    title="Banishing commands",
  ...
  # uno ban cell
  #############################################################################
  cmd_ban_cell = cli_command(grp_ban, "cell",
    cmd=registry_ban_cell,
  ...
  # uno ban particle
  #############################################################################
  cmd_ban_particle = cli_command(grp_ban, "particle",
    cmd=registry_ban_particle,
  ...
  # uno ban user
  #############################################################################
  cmd_ban_user = cli_command(grp_ban, "user",
    cmd=registry_ban_user,
    help="Exclude a user from the UVN.")

  cmd_ban_user.add_argument("email",
    help="The user's unique email.")
  ...
  # uno unban ...
  #############################################################################
  grp_unban = cli_command_group(subparsers, "unban",
  ...
  # uno unban cell
  #############################################################################
  cmd_unban_cell = cli_command(grp_unban, "cell",
    cmd=registry_unban_cell,
  ...
  # uno unban particle
  #############################################################################
  cmd_unban_particle = cli_command(grp_unban, "particle",
    cmd=registry_unban_particle,
  ...
  # uno unban user
  #############################################################################
  cmd_unban_user = cli_command(grp_unban, "user",
    cmd=registry_unban_user,
    help="Allow a user back into the UVN.")

  cmd_unban_user.add_argument("email",
    help="The user's unique email.")
  ...
  # uno delete ...
  #############################################################################
  grp_del = cli_command_group(subparsers, "delete",
    title="Unbanishing commands",
  ...
  # uno delete cell
  #############################################################################
  cmd_del_cell = cli_command(grp_del, "cell",
    cmd=registry_delete_cell,
  ...
  # uno delete particle
  #############################################################################
  cmd_del_particle = cli_command(grp_del, "particle",
    cmd=registry_delete_particle,
  ...
  # uno delete user
  #############################################################################
  cmd_del_user = cli_command(grp_del, "user",
    cmd=registry_delete_user,
    help="Delete a user from the UVN.")

  cmd_del_user.add_argument("email",
    help="The user's unique email.")
  ...
  # uno rekey ...
  #############################################################################
  grp_rekey = cli_command_group(subparsers, "rekey",
  ...
  # uno rekey particle
  #############################################################################
  cmd_rekey_particle = cli_command(grp_rekey, "particle",
  ...
  # uno rekey cell
  #############################################################################
  cmd_rekey_cell = cli_command(grp_rekey, "cell",
    cmd=registry_rekey_cell,
  ...
  # uno rekey uvn
  #############################################################################
  cmd_rekey_uvn = cli_command(grp_rekey, "uvn",
    cmd=registry_rekey_uvn,
